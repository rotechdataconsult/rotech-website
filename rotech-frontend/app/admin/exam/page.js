  ...
  return (
    <AdminLayout profile={profile} title="Final Exam Questions">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        {selectedDomain && (
          <span className="text-xs text-slate-400">{questions.length} question{questions.length !== 1 ? 's' : ''} total</span>
        )}
      </div>
        ...
        <div className="space-y-3">
          ...
          {questions.length === 0 && selectedDomain && (
            <div className="bg-[#1E293B] border border-slate-700/50 rounded-xl p-8 text-center">
              <p className="text-slate-400 text-sm">No questions yet. Add the first one.</p>
            </div>
          )}
          {!selectedDomain && (
            <div className="bg-[#1E293B] border border-slate-700/50 rounded-xl p-8 text-center">
              <p className="text-slate-400 text-sm">Select a domain to manage its final exam.</p>
            </div>
          )}
